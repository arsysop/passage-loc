...
import org.eclipse.passage.loc.workbench.emfforms.renderers.RestrictionLevelRenderer;
import org.eclipse.passage.loc.workbench.emfforms.renderers.StructuredFeatureRendererService;
import org.osgi.service.component.annotations.Component;
import org.osgi.service.component.annotations.Reference;

@Component
public class RestrictionLevelRendererService extends StructuredFeatureRendererService implements EMFFormsDIRendererService<VControl> {

	public RestrictionLevelRendererService() {
		super(RestrictionLevelRenderer.class, LicPackage.eINSTANCE.getProductVersionFeature_RestrictionLevel());
	}
