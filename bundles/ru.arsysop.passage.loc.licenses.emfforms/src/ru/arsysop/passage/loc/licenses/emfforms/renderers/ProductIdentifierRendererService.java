...
import ru.arsysop.passage.loc.products.emfforms.renderers.ProductIdentifierRenderer;
import ru.arsysop.passage.loc.workbench.emfforms.renderers.StructuredFeatureRendererService;

@Component
public class ProductIdentifierRendererService extends StructuredFeatureRendererService implements EMFFormsDIRendererService<VControl> {

	public ProductIdentifierRendererService() {
		super(ProductIdentifierRenderer.class, LicPackage.eINSTANCE.getLicensePack_ProductIdentifier());
	}
